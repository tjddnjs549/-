...
//    let tags: [String] // "Spurs", "Tottenham Hotspur", "토트넘" 등등
//
...
//    let apiUrl = URL(string: "https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2Cstatistics&chart=mostPopular&key=AIzaSyB4mgZGx7am_zDKQr4I75nerrwG0KFZVeE&maxResults=3&regionCode=KR")!
//
//    // Create a URLSession
...
//            //date 타입의 값을 별도의 디코딩을 해주지 않으면 Double로 디코딩하기 때문에 데이터 표준에 따라서 다음의 코드를 추가⭐️⭐️⭐️
...
let start = Date()
let end = start.addingTimeInterval(3600 * 24 * 60) // 내일로
